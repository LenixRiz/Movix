    ...
    return(
        <>
            <footer className="footer fixed-bottom">
                <section className="bg-dark py-4 py-md-5 py-xl-8">
                    ...
                    <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                        ...
                        <div className="widget">
                            ...
                            <address className="mb-4">Jl. Abdul Manan Wijaya, Kec. Pujon, Kab. Malang, Jawa Timur, Indonesia. 65391.</address>
                            <p className="mb-1">
                            <a className="text-white text-decoration-none" href="tel:+6282142550450">+62-821-425-504-50</a>
                            </p>
                            <p className="mb-0">
                            <a className="text-decoration-none text-white" href="mailto:rizky.fajarbusiness945@gmail.com">movix@yahoo.com</a>
                            </p>
                        </div>
                        </div>
                        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div className="widget">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="mb-2">
                                    <a href="#!" className="text-decoration-none text-white">Advertise</a>
                                </li>
                                <li className="mb-2">
                ...
                <div className="bg-dark py-4 py-md-5 py-xl-8">
                    <div className="container overflow-hidden">
                    <div className="row gy-4 gy-md-0 align-items-md-center">
                        <div className="col-xs-12 col-md-7 order-1 order-md-0">
                        <div className="copyright text-center text-md-start">
                            &copy; 2024 Movix. All Rights Reserved.
                        </div>
                        <div className="credits text-secondary text-center text-md-start mt-2 fs-8">
                            Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none fw-bold">RizkyHendricoKaisarKunlangArnoldOlipCahyo</a> with <span className="text-danger">&#9829;</span>
                        </div>
                        </div>
...
export const ShortFooter = () => {
    return(
        <>
            <footer className='footer fixed-bottom text-center mb-2'>
                <a href="#!" className='text-decoration-none text-white'>
                    <h5 className="fw-bold">Movix.</h5>
                </a>
                <div className="">
                    &copy; 2024 Movix. All Rights Reserved.
                </div>
